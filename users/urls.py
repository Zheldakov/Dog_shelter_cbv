...
from users.views import user_generate_new_password, UserRegisterView, UserLoginView, UserProfileView, UserUpdateView, \
    UserPasswordChangeView, UserLogoutView, UserListView, UserViewProfileView
