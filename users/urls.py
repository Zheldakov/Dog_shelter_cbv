...
from users.views import user_profile_view, user_logout_view, user_update_view,user_change_password_view, user_generate_new_password,UserRegisterView, UserLoginView
